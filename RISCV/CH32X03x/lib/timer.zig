...
pub const TimerSpec = packed struct(u16) {
    pwm_en: u2 = 0,
    reserved: u2 = 0,
    spec_pwm_oc1: bool = false,
    spec_pwm_oc2: bool = false,
    spec_pwm_oc3: bool = false,
    spec_pwm_oc4: bool = false,
    reserved2: u7 = 0,
    toggle: bool = false
};

pub const TimerCvr = packed struct(u32) {
    ccr: u16,
    level1: bool,
    reserved: u15
};
...
pub const adtm2: *volatile Timer = @ptrFromInt(TIMER2_BASE);
